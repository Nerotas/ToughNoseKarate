...
import { AssessmentSummary, CreateStudentAssessmentRequest, StudentAssessment, UpdateStudentAssessmentRequest } from '../models/Assessments/Assessments';


class StudentAssessmentsService {
  // Get all assessments for a student
  async getAssessmentsByStudent(studentId: number): Promise<StudentAssessment[]> {
    const response = await axiosInstance.get(`/v1/student-assessments/student/${studentId}`);
  ...
  async getAssessmentSummary(studentId: number): Promise<AssessmentSummary> {
    const response = await axiosInstance.get(
      `/v1/student-assessments/student/${studentId}/summary`
    );
    return response.data;
  }
  ...
  async getCurrentAssessment(studentId: number): Promise<StudentAssessment | null> {
    try {
      const response = await axiosInstance.get(
        `/v1/student-assessments/student/${studentId}/current`
      );
      return response.data;
    } catch (error: any) {
  ...
  async getAssessment(assessmentId: number): Promise<StudentAssessment> {
    const response = await axiosInstance.get(`/v1/student-assessments/${assessmentId}`);
    return response.data;
  }

  // Create a new assessment
  async createAssessment(data: CreateStudentAssessmentRequest): Promise<StudentAssessment> {
    const response = await axiosInstance.post('/v1/student-assessments', data);
    return response.data;
  }
  ...
  async updateAssessment(
    ...
    const response = await axiosInstance.patch(`/v1/student-assessments/${assessmentId}`, data);
    return response.data;
  }
  ...
  async completeAssessment(
    ...
    const response = await axiosInstance.patch(
      `/v1/student-assessments/${assessmentId}/complete`,
      data
    );
    return response.data;
  }
  ...
  async cancelAssessment(assessmentId: number, reason?: string): Promise<StudentAssessment> {
    const response = await axiosInstance.patch(`/v1/student-assessments/${assessmentId}/cancel`, {
      reason,
    });
    return response.data;
  }
  ...
  async deleteAssessment(assessmentId: number): Promise<void> {
    await axiosInstance.delete(`/v1/student-assessments/${assessmentId}`);
  }
  ...
  async getAssessmentsByStatus(
    ...
    const response = await axiosInstance.get(`/v1/student-assessments?status=${status}`);
    return response.data;
  }

  // Get all assessments by belt rank
  async getAssessmentsByBeltRank(beltRank: string): Promise<StudentAssessment[]> {
    const response = await axiosInstance.get(`/v1/student-assessments/belt-rank/${beltRank}`);
    return response.data;
  }
}

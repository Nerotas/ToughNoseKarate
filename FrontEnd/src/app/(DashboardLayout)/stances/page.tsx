...
const stances = [
  {
    ...
    beltColor: '#FFFFFF',
    description:
      'The formal attention stance used at the beginning and end of class.',
    position:
      'Feet together, heels touching, toes pointed outward at 45 degrees',
    bodyPosition:
      'Stand straight, shoulders back, arms at sides, hands in fists',
    keyPoints: [
  ...
  },
  {
    ...
    beltColor: '#FFFFFF',
    description:
      'The preparatory stance used before beginning techniques or forms.',
  ...
  },
  {
    ...
    beltColor: '#FFFFFF',
    description:
      'A strong, stable stance that builds leg strength and balance.',
  ...
  },
  {
    ...
    beltColor: '#FFFFFF',
    description:
      'An offensive stance that provides forward momentum and power.',
  ...
  },
  {
    ...
    beltColor: '#FFD700',
    description:
      'A defensive stance that allows quick retreating and counter-attacks.',
...
const Stances = () => {
  return (
    <PageContainer
      title='Stances'
      description='Tang Soo Do Basic Stances and Positions'
    >
      <Box>
        ...
        <Typography variant='body1' sx={{ mb: 4, color: 'text.secondary' }}>
          Proper stances form the foundation of all Tang Soo Do techniques. They
          provide stability, power generation, and mobility for effective
          martial arts practice.
        </Typography>

        <Alert severity='info' sx={{ mb: 4 }}>
          <Typography variant='body2'>
            <strong>Training Tip:</strong> Practice holding each stance for
            30-60 seconds to build leg strength and muscle memory. Focus on
            proper form over duration.
          </Typography>
        </Alert>

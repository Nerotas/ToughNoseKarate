-- Migration: Create kicks_definitions table
-- Description: Creates the kicks_definitions table to store kick technique definitions
CREATE TABLE IF NOT EXISTS `kicks_definitions` (
